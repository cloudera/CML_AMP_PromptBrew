...
import { InputVariablesContainer } from "./InputVariablesContainer";

const { Text } = Typography;

export const variablesPanelName = "variables";
const variablePanelLabel = (
  <Typography>
    Advanced
...
export const collapseVariables = (
  inputVariables: Variable[],
  setInputVariables: React.Dispatch<React.SetStateAction<Variable[]>>,
): CollapseProps["items"] => [
  {
    key: variablesPanelName,
    label: variablePanelLabel,
    children: (
